...
const StyledInlineNotification = withProps<PropsType, HTMLSpanElement>(styled.span)`
    transition: color 0.3s;
    font-family: ${({ theme }): string => theme.InlineNotification.common.fontFamily};
    font-size: ${({ theme }): string => theme.InlineNotification.common.fontSize};
