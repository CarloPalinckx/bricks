...
import BreakpointProvider, { PropsType } from '../../components/BreakpointProvider';
import StyledModal, { StyledModalWrapper } from '../../components/Modal/style';
import TransitionAnimation from '../../components/TransitionAnimation';
import Button from '../../components/Button';

jest.mock('../../components/ScrollBox', () => jest.fn().mockImplementation((props: PropsType): string => 'div'));
